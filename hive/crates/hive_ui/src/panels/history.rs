...
use crate::workspace::{HistoryDeleteConversation, HistoryLoadConversation, HistoryRefresh};
...
fn render_conversation_card(
    ...
    let delete_btn_element_id =
        SharedString::from(format!("conv-delete-{}", &summary.id));
