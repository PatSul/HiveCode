...
impl FilesPanel {
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .gap(theme.space_2)
                    .child(Icon::new(IconName::Folder).size_4().text_color(theme.text_primary))
                    .child(
                        div()
                ...
                div()
                    ...
                    .on_mouse_down(MouseButton::Left, move |_event, window, cx| {
                        window.dispatch_action(
                            Box::new(FilesNavigateTo { path: nav_path.clone() }),
                            cx,
                        );
                    })
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .border_color(theme.border)
                    .gap(theme.space_2)
                    .child(Icon::new(IconName::Search).size_3p5().text_color(theme.text_muted))
                    .child(
                        div()
                            .flex_1()
                            .text_size(theme.font_size_sm)
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(Icon::new(open_icon).size_3p5().text_color(theme.text_secondary)),
            )
            // Delete button
            .child(
                div()
                    ...
                    .child(Icon::new(IconName::Delete).size_3p5().text_color(theme.accent_red)),
            )
    }
    ...
    fn empty_state(theme: &HiveTheme) -> impl IntoElement {
        div()
            ...
            .py(theme.space_8)
            .gap(theme.space_3)
            .child(Icon::new(IconName::FolderOpen).size_6().text_color(theme.text_muted))
            .child(
                div()
                    .text_size(theme.font_size_base)
                    .text_color(theme.text_muted)
